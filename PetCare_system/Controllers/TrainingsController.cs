    ...
    public class TrainingsController : Controller
    {
        ...
        public ActionResult Dashboard(int? petId)
        {
            ...
            if (!petId.HasValue)
            {
                ...
                {
                    return RedirectToAction("Create", "Pets"); // Redirect to create a pet if none exist
                }
            }
        ...
        // Other existing methods (Modules, StartModule, GetQuizQuestions, SubmitQuiz, etc.) remain the same
        // ...
        ...
        // Add these methods to your existing TrainingsController class
